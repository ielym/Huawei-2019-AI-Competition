...
# 算法模型
***    
&ensp;&ensp;&ensp;&ensp;刚好研究生入学确定方向后不久就碰到了这个比赛，比赛大概一个多月时间，按照 <b>Baseline（ResNet50）</b> 和大佬分享经验开始接触图像分类经典模型论文和代码，包括：     
...
&ensp;&ensp;&ensp;&ensp;直到...看到比赛群里大佬分享的 <b>EfficientNets</b> 这是什么神仙操作？？？原来深度学习模型效果和模型深度/宽度，还和输入图像分辨率都有关啊！而且好像还不是模型越复杂越好，另外有钱确实任性。

&ensp;&ensp;&ensp;&ensp;所以，这次比赛最终使用<b>Efficient-b6</b>模型，借助比赛提供的免费Model Arts平台进行了模型训练（本地1080ti实在是训练不动）     
&ensp;&ensp;&ensp;&ensp;最终，获得了线上95.9的准确率评分，最终排名是top 10%。
...
***
&ensp;&ensp;&ensp;&ensp;足够幸运，才能在研究生入学不久就遇见这场图像分类比赛带我走进CV的世界     
