...
def split_train_val(input_dir, output_train_dir, output_val_dir):
    """
    python prepare_data.py --input_dir ./train_data --output_train_dir ./train_val/train --output_val_dir ./train_val/val
    """
    ...
    sss = StratifiedShuffleSplit(n_splits=1, test_size=54, random_state=0)
